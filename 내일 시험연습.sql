...
alter table test 
MODIFY age number(3) Defaul 0 not null;
...
insert into test values('yoon2','$2222','윤호섭','M',27,'대구광역시');
insert into test values('#lee3','#3333','이수광','M',30,'서울특별시');
insert into test values('an4','&4444','안여진','F',27,'부산광역시');
...
ON test(name);
--16-2. index 생성 데이터 사전을 이용하여 index 목록 확인
select * 
from USER_indexES
